...
local function IRISWatermark()
    ...
    if engine.IsGameUIVisible(true) then
        ...
        draw.SetFont(tf2)
        draw.Text(10, 40, "V1.1 Public Release")
    end
end
...
local priorities = {
    "Fuck You", -- Priority 1
    "Possible Pedo/Weirdo", -- Priority 2
    "Streamer", -- Priority 3
    "Vote Caller", -- Priority 4
    "Annoying", -- Priority 5
    "Pedo/Weirdo", -- Priority 6
    "Closet", -- Priority 7
    "Sus", -- Priority 8
    "Bot", -- Priority 9
    "Cheater" -- Priority 10
...
local function secondary()
    ...
    if engine.IsGameUIVisible(true) then
        ...
        draw.Text(10, 315, "1 - Fuck You")
        draw.Color(250, 119, 32, 255)
        draw.Text(10, 330, "2 - Possible Pedo/Weirdo")
        ...
        draw.Text(10, 390, "6 - Pedo/Weirdo")
...
local function textDraw()
    ...
    if engine.IsGameUIVisible(true) then
        ...
        draw.Text(200, 300, "IRIS KDA Stats")
        draw.SetFont(tahoma)
        draw.Color(255, 148, 112, 255)
        draw.Text(200, 315, "Kills: " .. killCount)
        draw.Color(159, 90, 253, 255)
        draw.Text(200, 330, "Deaths: " .. deathCount)
        draw.Color(3, 138, 255, 255)
        draw.Text(200, 345, "Assists: " .. assistCount)

        KDCount = killCount / deathCount
        KDCount = math.floor(KDCount)

        draw.Color(0, 230, 64, 255)
        draw.Text(200, 360, "KD: " .. KDCount)
...
callbacks.Register("Draw", "KDA", textDraw)
